                    ...
                    <div class="eeta-audience-cards__card">
                        <?php if ( ! empty( $card['icon'] ) ) : ?>
                            <div class="eeta-audience-cards__card-icon">
                                <img src="<?php echo esc_url( $card['icon']['url'] ); ?>" alt="<?php echo esc_attr( $card['icon']['alt'] ); ?>" width="64" height="64" loading="lazy" />
                            </div>
                        <?php endif; ?>
                            ...
                            <ul class="eeta-audience-cards__bullets">
                                <?php foreach ( $card['bullet_points'] as $bp ) : ?>
                                    <?php if ( ! empty( $bp['point'] ) ) : ?>
                                        <li class="eeta-audience-cards__bullet"><span class="eeta-bullet-dot"></span><?php echo esc_html( $bp['point'] ); ?></li>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
