...
class Custom_Porel_Posts_Grid extends Widget_Base {
  public function __construct( $data = [], $args = null ) {
    parent::__construct( $data, $args );
  }

  public function get_name() {
    return 'Custom_Porel_Posts_Grid';
  }
  ...
  protected function register_controls() {
    ...
    $this->add_control(
      ...
      [
        ...
        'multiple' => false,
        'default'  => 'post',
        'options'  => POR_Core::instance()->helpers->get_post_types_options(),
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'multiple' => false,
        'default'  => '',
        'options'  => POR_Core::instance()->helpers->get_taxonomies_options(),
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'placeholder' => '',
        'condition'   => [
          'taxonomy' => array_keys( POR_Core::instance()->helpers->get_taxonomies_options() ),
        ],
      ]
    );
  ...
  protected function render() {
    ...
    ?>
    <div id="<?= $uid ?>" class="porel-posts-grid">
      <div class="porel-posts-grid__posts">
        <?php
