...
class Custom_El_Products_Single_Faqs extends Widget_Accordion {
  public function __construct( $data = [], $args = null ) {
    parent::__construct( $data, $args );
  }

  public function get_name() {
    return 'Custom_El_Products_Single_Faqs';
  }
  ...
  protected function render() {
    if ( ! is_product() || empty( $faqs = get_field( 'faqs' ) ) ) {
      return;
    }

    $uid      = uniqid( 'el-products-single-faqs-' );
