...
class Custom_El_Products_Archive_Grid extends Widget_Base {
          ...
          <div class="row row-cols-1 row-cols-xl-4 row-cols-xxl-5">
            ...
            <div class="col flex-xl-grow-1">
              ...
              $args = [
                ...
                'preloaded'                    => 'true',
                'preloaded_amount'             => 12,
                'transition_container_classes' => $MIT_helpers->is_product_cat_belongs_to_industrial( $queried_object->term_id ) ? 'row row-cols-1' : 'row row-cols-1 row-cols-md-2 row-cols-xxl-4',
                'images_loaded'                => 'true',
                'taxonomy'                     => $queried_object->taxonomy,
